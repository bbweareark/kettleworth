...
/** Shared pool of rest-deck content. Generated by the model in batches; per-user "seen" lives in rest_activity.item_id. */
export const restItem = pgTable("rest_item", {
  id: text("id").primaryKey(),
  kind: text("kind").$type<"quiz" | "fact">().notNull(),
