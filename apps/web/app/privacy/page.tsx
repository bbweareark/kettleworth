  ...
  return (
    <main className="page max-w-3xl py-12 space-y-6">
      ...
      {[
        ...
        ["Food photos and barcodes", "A food photo is read once to estimate what is on the plate and is not stored; only the numbers you choose to log are kept. Barcodes are looked up in Open Food Facts, a public product database, and the product details are cached without anything about you."],
        ["Progress photos", "Photos you upload are stored privately, shown only to you, and sent to the coaching model only when you press Read. The read is a visual estimate, never a diagnosis. Delete any photo at any time; all photos are deleted with your account."],
        ["Coaching model", "When live coaching is enabled, your profile and plan are sent to Anthropic's Claude API to write coaching text and ask follow-up questions. Prompts and outputs are logged for quality evaluation. The model cannot change your programme directly; a rules engine validates everything."],
