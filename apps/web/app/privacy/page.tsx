  ...
  return (
    <main className="page max-w-3xl py-12 space-y-6">
      ...
      {[
        ...
        ["Progress photos", "Photos you upload are stored privately, shown only to you, and sent to the AI coach only when you press Read. The read is a visual estimate, never a diagnosis. Delete any photo at any time; all photos are deleted with your account."],
