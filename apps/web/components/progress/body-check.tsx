    ...
    <Card><CardContent className="space-y-4">
      ...
      {latest ? (
        <div className="space-y-3 rounded-xl border border-border p-4">
          ...
          <div className="flex items-center gap-4"><MuscleFigure muscles={priorityMuscles} sex={sex} size="md" caption={priorityMuscles.length > 0} /><div className="flex flex-wrap gap-2"><Badge tone="ember" className="capitalize">{label(latest.build)} build</Badge>{latest.bodyFatRangePct ? <Badge tone="outline">Body fat ~{latest.bodyFatRangePct[0]} to {latest.bodyFatRangePct[1]}%</Badge> : null}</div></div>
